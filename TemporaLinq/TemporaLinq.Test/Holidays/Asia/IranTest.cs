...
public class IranTest
{
    ...
    public void GetHolidays_ContainsPersianCalendarHolidays()
    {
        ...
        holidays.Should().Contain(h => h.Date == new DateOnly(2026, 3, 22) && h.Name == NowruzDay);
        holidays.Should().Contain(h => h.Date == new DateOnly(2026, 3, 23) && h.Name == NowruzDay);
        holidays.Should().Contain(h => h.Date == new DateOnly(2026, 3, 24) && h.Name == NowruzDay);
