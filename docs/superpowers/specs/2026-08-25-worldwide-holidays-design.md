...
### Asia
- Done: ✅ China (Tier AS1)
- Tier AS1: India (Hijri- and Easter-computable; central Gazetted list only — Hindu-calendar holidays and state-specific days deferred), Israel (Hebrew-computable), Japan, South Korea (Korean-lunisolar-computable), Singapore (Hijri- and Chinese-lunisolar-computable components only — Hindu/Buddhist components deferred), Turkey (Hijri-computable)
- Done: ✅ Vietnam (Tier AS2)
- Tier AS2: Philippines, Indonesia (Hijri- and Easter-computable components only — Nyepi/Vesak deferred), Malaysia (Hijri- and Chinese-lunisolar-computable components only — Hindu/Buddhist components deferred), Pakistan (Hijri-computable), Bangladesh (Hijri-computable component only — Hindu/Buddhist minority holidays deferred), Saudi Arabia (Hijri-computable), UAE (Hijri-computable)
- Done: ✅ Hong Kong (Tier AS3)
- Tier AS3: 🔴 Thailand (Buddhist lunar calendar, still hard), Taiwan (Taiwan-lunisolar-computable), Kazakhstan, Qatar (Hijri-computable), Kuwait (Hijri-computable), Iraq (Hijri-computable, approximate — Sunni/Shia moon-sighting authorities occasionally differ by a day), Iran (Persian- and Hijri-computable)
